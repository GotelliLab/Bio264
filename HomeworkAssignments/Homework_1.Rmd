...
And, just for fun, typeset in your document these familiar equations from ecology and evolution:

$$N_t = N_0e^{rt}$$

$$\frac{dN}{dt} = rN\left(1 - \frac{N}{K}\right)$$

For the second equation, you will have to search on the web to figure out how to give a LaTeX command that will generate the "large" parentheses.
...
When you come to class, have your computer these files to copy onto a flash drive and transfer to Dr. Gotelli:

1. `<Your last name>_HW#1_28Jan2016.Rmd`. 
2. `<Your last name>_HW#1_SlideShow_28Jan2016.Rmd`. 
